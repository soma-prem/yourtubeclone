                    ...
                    <tr>
                      <td style="padding: 40px 30px;">
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 30px;">
                          <tr>
                            <td align="center">
                              <a href="${"https://yourtubeclone-sp103-gqsn2rkck-financeaiadvisors-projects.vercel.app/premium"}" style="display: inline-block; padding: 14px 30px; background-color: #cc0000; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 16px;">Start Watching Now</a>
                            </td>
                          </tr>
                        </table>
